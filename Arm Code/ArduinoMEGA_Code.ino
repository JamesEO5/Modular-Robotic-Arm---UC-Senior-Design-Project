...
int pos1 = 512; //needs to be mapped to 1800
int pos2 = 512; //needs to be mapped to 1300
int pos3 = 512; //needs to be mapped to 1400
int pos4 = 512; //needs to be mapped to 1500
int pos5 = 512; //needs to be mapped to 1700
int pos6 = 512; //needs to be mapped to 1500
...
void readJoysticks() {
  ...
  if (currTime - moveTime >= readtime ) {   //if the difference between move time and current time is the delay period, then
...
void readJoy1() {
  ...
  if (v1 > 800) { //above the positive deadband
    pos1++; //increment the position of servo
  }
  else if (v1 < 200) {  //below the negative deadband
...
void readJoy2() {
  ...
  if (v2 > 800) { //above the positive deadband
    pos2++;
  }
  else if (v2 < 200) {  //below the negative deadband
    pos2--;
  }
...
void readJoy3() {
  ...
  if (v3 > 800) { //above the positive deadband
    pos3++;
  }
  else if (v3 < 200) {  //below the negative deadband
    pos3--;
  }
...
void readJoy4() {
  ...
  if (v4 > 800) { //above the positive deadband
    pos4++;
  }
  else if (v4 < 200) {  //below the negative deadband
    pos4--;
  }
...
void readJoy5() {
  ...
  if (v5 > 800) { //above the positive deadband
    pos5++;
  }
  else if (v5 < 200) {  //below the negative deadband
    pos5--;
  }
...
void readJoy6() {
  ...
  if (v6 > 800) { //above the positive deadband
    pos6 = pos6 + gripperspeed;
  }
  else if (v6 < 200) {  //below the negative deadband
    pos6 = pos6 - gripperspeed;
  }
...
void spin() {
    ...
    movePreset(2, 1675, 2000);
    delay(50);
    movePreset(3, 1400, 1725);
    delay(50);
    movePreset(5, 1550, 1900);
    delay(50);
    movePreset(1, 1390, 1400);
    delay(50);

    movePreset(2,2000, 1990);
    movePreset(3, 1800, 1810);
    movePreset(5, 1900, 1910);

    movePreset(2,1990, 1980);
    movePreset(3, 1810, 1820);
    movePreset(5, 1910, 1920);

    movePreset(2,1980, 1970);
    movePreset(3, 1820, 1830);
    movePreset(5, 1920, 1930);

    movePreset(2,1970, 1960);
    movePreset(3, 1830, 1840);
    movePreset(5, 1930, 1940);

    movePreset(2,1960, 1950);
    movePreset(3, 1840, 1850);
    movePreset(5, 1940, 1950);

    movePreset(2,1950, 1940);
    movePreset(3, 1850, 1860);
    movePreset(5, 1950, 1960);

    movePreset(2,1940, 1930);
    movePreset(3, 1860, 1870);
    movePreset(5, 1960, 1970);

    movePreset(2,1930, 1920);
    movePreset(3, 1870, 1880);
    movePreset(5, 1970, 1980);

    movePreset(2,1920, 1910);
    movePreset(3, 1880, 1890);
    movePreset(5, 1980, 1990);

    movePreset(2,1910, 1900);
    movePreset(3, 1890, 1900);
    movePreset(5, 1990, 2000);

    movePreset(2,1900, 1890);
    movePreset(3, 1900, 1910);
    movePreset(5, 2000, 2010);

    movePreset(2,1890, 1880);
    movePreset(3, 1910, 1920);
    movePreset(5, 2010, 2020);

    movePreset(2,1880, 1870);
    movePreset(3, 1920, 1930);
    movePreset(5, 2020, 2030);

    movePreset(2,1870, 1860);
    movePreset(3, 1930, 1940);
    movePreset(5, 2030, 2040);

    movePreset(2,1860, 1850);
    movePreset(3, 1940, 1950);
    movePreset(5, 2040, 2050);

    movePreset(2,1850, 1840);
    movePreset(3, 1950, 1960);
    movePreset(5, 2050, 2060);

    movePreset(2,1840, 1830);
    movePreset(3, 1960, 1970);
    movePreset(5, 2060, 2070);

    movePreset(2,1830, 1820);
    movePreset(3, 1970, 1980);
    movePreset(5, 2070, 2080);

    movePreset(2,1820, 1810);
    movePreset(3, 1980, 1990);
    movePreset(5, 2080, 2090);

    movePreset(2,1810, 1800);
    movePreset(3, 1990, 2000);
    movePreset(5, 2090, 2100);
    delay(500);

    movePreset(1, 1400, 1300);
    delay(500);

    movePreset(2, 1800, 1810);
    movePreset(3, 2000, 1990);
    movePreset(5, 2100, 2090);

    movePreset(2, 1810, 1820);
    movePreset(3, 1990, 1980);
    movePreset(5, 2090, 2080);

    movePreset(2, 1820, 1830);
    movePreset(3, 1980, 1970);
    movePreset(5, 2080, 2070);

    movePreset(2, 1830, 1840);
    movePreset(3, 1970, 1960);
    movePreset(5, 2070, 2060);

    movePreset(2, 1840, 1850);
    movePreset(3, 1960, 1950);
    movePreset(5, 2060, 2050);

    movePreset(2, 1850, 1860);
    movePreset(3, 1950, 1940);
    movePreset(5, 2050, 2040);

    movePreset(2, 1860, 1870);
    movePreset(3, 1940, 1930);
    movePreset(5, 2040, 2030);

    movePreset(2, 1870, 1880);
    movePreset(3, 1930, 1920);
    movePreset(5, 2030, 2020);

    movePreset(2, 1880, 1890);
    movePreset(3, 1920, 1910);
    movePreset(5, 2020, 2010);

    movePreset(2, 1890, 1900);
    movePreset(3, 1910, 1900);
    movePreset(5, 2010, 2000);

    movePreset(2, 1900, 1910);
    movePreset(3, 1900, 1890);
    movePreset(5, 2000, 1990);

    movePreset(2, 1910, 1920);
    movePreset(3, 1890, 1880);
    movePreset(5, 1990, 1980);

    movePreset(2, 1920, 1930);
    movePreset(3, 1880, 1870);
    movePreset(5, 1980, 1970);

    movePreset(2, 1930, 1940);
    movePreset(3, 1870, 1860);
    movePreset(5, 1970, 1960);

    movePreset(2, 1940, 1950);
    movePreset(3, 1860, 1850);
    movePreset(5, 1960, 1950);

    movePreset(2, 1950, 1960);
    movePreset(3, 1850, 1840);
    movePreset(5, 1950, 1940);

    movePreset(2, 1960, 1970);
    movePreset(3, 1840, 1830);
    movePreset(5, 1940, 1930);

    movePreset(2, 1970, 1980);
    movePreset(3, 1830, 1820);
    movePreset(5, 1930, 1920);

    movePreset(2, 1980, 1990);
    movePreset(3, 1820, 1810);
    movePreset(5, 1920, 1910);

    movePreset(2, 1990, 2000);
    movePreset(3, 1810, 1800);
    movePreset(5, 1910, 1900);

    delay(50);


    movePreset(5, 1900, 1600);
    movePreset(3, 1800, 1900); // new letter
    delay(50);
    movePreset(2, 2000, 1675);
    delay(50);
    

    movePreset(1, 1300, 1150); //start next letter

    movePreset(5, 1600, 1900);
    delay(50);
    movePreset(3, 1600, 1725);
    delay(50);
    movePreset(2, 1675, 2000);
    delay(50);
    

    movePreset(1, 1150, 1250);
...
void wave() {
  ...
  movePreset(2, 1600, 1675);
  movePreset(3, 1380, 1400);
...
void grabCan() {
  ...
  movePreset(1, 1425, 1400);
  delay(1000);

  movePreset(2, 1700, 1675);
  delay(1000); 

  movePreset(3, 1425, 1400);
  delay(1000);

  movePreset(4, 1525, 1500);
  delay(1000);

  movePreset(5, 1575, 1550);
  delay(1000);

  movePreset(6, 1400, 1375);
  delay(2000);
  // for Q = 1:1000
